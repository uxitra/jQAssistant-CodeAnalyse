package com.example.moviescheduler.movie.web;

import com.example.moviescheduler.movie.service.MovieDto;
import com.example.moviescheduler.movie.service.MovieService;
...
class MoviesControllerTest {
    ...
    void whenGetMovieCalledWithIdThenReturnMovie() throws Exception {
        ...
        when(movieService.getMovie("movieId")).thenReturn(Optional.of(movie));
